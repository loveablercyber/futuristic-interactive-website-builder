	...
	theme: {
		...
		extend: {
			...
			keyframes: {
				...
				'pulse-glow': {
					'0%, 100%': { 
						boxShadow: '0 0 5px 0 rgba(0, 240, 255, 0.3)',
						transform: 'scale(1)'
					},
					'50%': { 
			...
			backgroundImage: {
				...
				'shimmer': 'linear-gradient(90deg, transparent, rgba(0, 240, 255, 0.8), transparent)',
				'neon-glow': 'linear-gradient(to right, #00F0FF, #7B61FF, #FF61E6, #00F0FF)',
			},
			boxShadow: {
